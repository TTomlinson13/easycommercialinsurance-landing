...
const ORIGIN = 'https://easycommercialinsurance.com'

const OG_IMAGE = `${ORIGIN}/og-image.png`
const LOGO = `${ORIGIN}/hero-commercial.jpg`
...
const AGENCY = {
  ...
  description:
    'Independent Florida commercial insurance agency. Business owners policies, general liability, workers compensation and commercial auto, quoted across multiple carriers. Part of Tomlinson & Co, licensed since 1966.',
  areaServed: [
...
const BLOG_DESCRIPTION =
  'Florida commercial insurance news and plain-English guides: business owners policies, general liability, workers compensation requirements, umbrella coverage, and what small businesses actually need.'
...
const routes = [
  {
    ...
    out: 'index.html',
    title:
      'Easy Commercial Insurance | Florida Business Coverage | 800-616-1418',
    description:
      'Easy Commercial Insurance - Florida business insurance made simple. BOP, general liability, workers comp, commercial auto. Get quotes in minutes. Call 800-616-1418',
    ogType: 'website',
    schemas: [
      AGENCY,
      {
    ...
    schemas: [
      {
        ...
        '@id': `${ORIGIN}/blog#blog`,
        url: `${ORIGIN}/blog`,
        name: 'The Easy Commercial Insurance Blog',
        description: BLOG_DESCRIPTION,
        publisher: { '@id': `${ORIGIN}/#agency` },
  ...
  ...posts.map((post) => ({
    ...
    title: `${post.title} | EasyCommercialInsurance.com`,
    ...
    schemas: [
      {
        ...
        articleSection: 'Florida Commercial Insurance',
        inLanguage: 'en-US',
        image: OG_IMAGE,
